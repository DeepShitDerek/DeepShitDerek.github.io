...
export default function TopicEditor({ topic, onBack, onTopicUpdate }: TopicEditorProps) {
  ...
  useEffect(() => {
    if (topic) {
      ...
      setResources(rawResources.map((res: any) => ({ name: res.name || "Untitled", url: res.url || "" })));
    }
  }, [topic]);
    ...
    <div className={cn(
      ...
      */}
      ...
      {/* 
        ...
        This is the single source of truth for scrolling.
        NovelEditor flows naturally inside here.
      */}
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto w-full flex flex-col min-h-full">
          ...
          {/* 
            Main Editor 
            Note: We do NOT use absolute positioning here. 
            We let it flow. The 'sticky' toolbar inside NovelEditor will stick to the top of THIS container.
          */}
          <div className="flex-1 px-4 pb-12">
            <NovelEditor
              ...
              minHeight="500px" // Ensures decent height even when empty
              isRounded={true}
